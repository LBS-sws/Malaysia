...
$this->pageTitle=Yii::app()->name . ' - Word Form';
?>
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('contract','Word Form'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
	...
	<div class="box box-info">
		<div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <?php echo $form->inlineRadioButtonList($model, 'type',array("local"=>Yii::t("contract","local"),"default"=>Yii::t("contract","default")),
...
?>
<?php
$wordFileInput="<div class='col-sm-3 word'><input id='ytWordForm_file' type='hidden' value='' name='WordForm[file]'><input class='form-control' name='WordForm[file]' id='WordForm_file' type='file'></div>";
$js = '
...
$js = Script::genDeleteData(Yii::app()->createUrl('word/delete'));
