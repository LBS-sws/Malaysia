<tr>
	...
	<th>
		<?php echo TbHtml::link($this->getLabelName('city').$this->drawOrderArrow('city'),'#',$this->createOrderLink('employee-list','city'))
			;
		?>
	</th>
	<th>
	...
	<th>
		<?php echo TbHtml::link($this->getLabelName('status').$this->drawOrderArrow('z_index'),'#',$this->createOrderLink('employee-list','z_index'))
			;
		?>
	</th>
    <th width="1%">
